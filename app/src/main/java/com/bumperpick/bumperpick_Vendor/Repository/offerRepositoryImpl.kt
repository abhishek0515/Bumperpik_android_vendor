...
class OfferRepositoryImpl(
    ...
    override suspend fun AddOffer(offerModel: OfferModel,templateData: Template_Data): Result<success_model> {
        return try {
            ...
            map["heading"] = templateData.heading?.text.toString().toRequestBody("text/plain".toMediaType())
            map["subheading"] = templateData.subHeading?.text.toString().toRequestBody("text/plain".toMediaType())
            map["discount"] = offerModel.discount.text.toString().toRequestBody("text/plain".toMediaType())
            map["brand_name"] = templateData.brandName?.text.toString().toRequestBody("text/plain".toMediaType())
            ...
            Log.d("BannerImage",offerModel.BannerImage.toString())
